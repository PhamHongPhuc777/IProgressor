...
| Mạng quản trị riêng | NetBird (cloud)                          | Bảo vệ các cổng nhạy cảm, kết nối WebUI URL trực tiếp — NetBird có policy/ACL theo nhóm (sync trực tiếp từ Zitadel qua OIDC) xuống tới từng host/service cụ thể                                                                                    |
