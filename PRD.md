...
| Trưởng phòng / PM | Lập kế hoạch dự án, chia milestone/task, phân bổ nguồn lực, theo dõi rủi ro |
| Ban lãnh đạo / Quản lý cấp cao | Xem tổng quan đa phòng ban, hiệu suất nhân sự, dự án có nguy cơ trễ |
| IT Admin | Quản lý workspace, phân quyền, tích hợp hệ thống nội bộ |
...
- Là **PM**, tôi muốn chia dự án thành milestone và task, gán người phụ trách để kiểm soát tiến độ.
- Là **trưởng phòng**, tôi muốn xem workload của từng thành viên để phân công công bằng, tránh quá tải.
- Là **quản lý cấp cao**, tôi muốn xem dashboard tổng hợp tiến độ tất cả phòng ban trên một màn hình để ra quyết định nhanh.
- Là **IT admin**, tôi muốn phân quyền workspace theo phòng ban để đảm bảo bảo mật dữ liệu.
