...
- **Thành viên dự án (Member):** xem/cập nhật task được giao.
- **Quản lý dự án (Project Manager):** tạo dự án, phân bổ nguồn lực, theo dõi tiến độ.
- **Quản trị workspace (Workspace Admin):** quản lý thành viên và quyền trong phạm vi phòng ban.
- **Quản trị hệ thống (System Admin):** quản lý toàn hệ thống, tích hợp, bảo mật.
...
### FR-3: Phân rã công việc và phân bổ nguồn lực
...
- Hiển thị dữ liệu theo nhiều dạng view: Kanban board, danh sách, timeline/Gantt.

### FR-4: Theo dõi và báo cáo cho vai trò quản lý
...
- Đáp ứng tốt cho quy mô CRUD/dashboard nội bộ (không yêu cầu render real-time khối lượng cực lớn); React.js/Vite đáp ứng đủ, không cần tối ưu hiệu năng đặc biệt kiểu Solid.js.
...
- Chỉ cân nhắc tách microservices/Spring Cloud khi có nhu cầu scale thực tế theo từng domain riêng lẻ.
