...
| Mạng quản trị riêng   | NetBird (cloud)               | Bảo vệ các cổng nhạy cảm, kết nối DB và WebUI URL trực tiếp — NetBird có policy/ACL theo nhóm (sync trực tiếp từ Zitadel qua OIDC) xuống tới từng host/service cụ thể                                                                              |
| Tích hợp chia sẻ file | Microsoft Graph API           | Chọn theo hạ tầng Microsoft 365, tích hợp tính năng chia sẻ file qua SharePoint                                                                                                                                                                    |
...
| OIDC bên ngoài        | Google (OAuth2)               | Một lựa chọn "Đăng nhập bằng Google" bổ sung cho Zitadel, cùng nhóm với Entra ID/AD-LDAP — cấu hình tại Zitadel                                                                                                                                    |
